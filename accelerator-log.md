...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=clarkjo-vmware&repo=python-azure",
  "functionName" : "main",
  "includeTap" : true,
  "interfaceType" : "http",
  "projectName" : "python-azure"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-function->python-azure, main->main]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=clarkjo-vmware&repo=python-azure'
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-function->python-azure]
